...
//    }
    ...
    init(userName: String, userTeam: String, userAvatarHeight: CGFloat, userAvatarURL: String, userPosition: Int, userGender: Int, userHeight: String, userweight: String){
    ...
    init?(dictionary: [String: Any], key: String){
        ...
        self.userPosition = dictionary["userPosition"] as! Int
        self.userGender = dictionary["userGender"] as! Int
