...
class Game {
    ...
    init(imageURL: String, imageHeight: CGFloat, gameTitle: String, gameLocation: String, gameTime: String, gameDescription: String, gamePlayer: [String]){
    ...
    init?(dictionary: [String: Any], key: String){
        ...
        self.gamePlayer = dictionary["gamePlayer"] as! [String]
        self.key = key
